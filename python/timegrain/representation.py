...
The binning and the reduction are not written here. They are ``src/tg_core.cpp``, compiled into
``timegrain._core`` and into the R package alike, so the two languages agree by construction rather
