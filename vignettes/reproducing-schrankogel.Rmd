...
grid <- grain_ladder(ladder_input, y, c(encoders, list(ensemble = ensemble)), folds = folds)
summary(grid)
```
...
Rscript schrankogel.R <deposit_dir> <out_dir> \
  ...
  --grains=day,week,month,season,year --learners=cnn,rescnn,mlp --folds=folds.csv
```
