...
Left at `None` the grains are the ones the record supports, the set `auto_grains`
...
`tz` names the calendar, as it does for `grain_matrix`. The anchors are instants and
