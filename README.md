...
truth is 0.60. Most species distribution code carries that silently. `tss_inflation()` measures it
for your design, and `paired_contrast()` is where it cancels, because both arms carry the same bias
on the same cell.
