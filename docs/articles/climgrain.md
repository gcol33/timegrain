...
the analyst settled on once. `climgrain` makes that reduction an
...
x
#> <climgrain matrix> 60 units x 18 bins x 3 channels 
...
folds
#> <climgrain folds> 60 units in 5 folds 
#> fold
#>  1  2  3  4  5 
#> 13 11 11 13 12
```
...
#> <climgrain cells> 30 cells over 6 variables 
...
across species.](climgrain_files/figure-html/plot-1.svg)
