...
- [Extending](https://gillescolling.com/timegrain/articles/python-extending.md):

  The response head and the metric are registrations, never a fork of
  the fitting code.

- [What crosses the
  boundary](https://gillescolling.com/timegrain/articles/python-artifacts.md):
